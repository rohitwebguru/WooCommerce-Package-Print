...
.wfte_doc_title{ color:#23a8f9; font-size:30px; font-weight:bold; height:auto; width:auto; float:right; line-height:22px;}
...
<div class="wfte_rtl_main wfte_invoice-main">
        ...
        <div class="wfte_col-2 float_right">
            <div class="wfte_invoice_data float_right">
                <div class="wfte_invoice_number">
                    <span class="wfte_invoice_number_label">__[Invoice]__ </span><span class="wfte_invoice_number_val" style="font-weight:normal;">#[wfte_invoice_number]</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="wfte_row wfte_padding_left_right clearfix">
        <div class="wfte_addrss_field_main clearfix">
            ...
            <div class="wfte_col-3 float_right wfte_text_left">
        ...
        <div class="wfte_col-1">
            ...
            <table class="wfte_payment_summary_table wfte_product_table">
                <tbody class="wfte_payment_summary_table_body wfte_table_body_color">
                    ...
                    <tr class="wfte_payment_summary_table_row wfte_product_table_payment_total wfte_table_head_color wfte_product_table_head_bg">
