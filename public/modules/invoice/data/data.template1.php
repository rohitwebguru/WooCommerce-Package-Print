<div class="wfte_rtl_main wfte_invoice-main">
    <div class="wfte_invoice-header wfte_invoice-header_color clearfix">
        <div class="wfte_invoice-header_top clearfix">
            ...
            <div class="float_right" style="width:23%;">
    ...
    <table class="wfte_payment_summary_table wfte_product_table">
        <tbody class="wfte_payment_summary_table_body wfte_table_body_color">
            ...
            <tr class="wfte_payment_summary_table_row wfte_product_table_payment_method">
                <td colspan="2" class="wfte_product_table_payment_method_label wfte_text_right">__[Payment Method]__</td>
            ...
            <tr class="wfte_payment_summary_table_row wfte_product_table_payment_total">
                ...
                <td class="wfte_product_table_payment_total_val wfte_right_column wfte_table_head_color wfte_product_table_head_bg">[wfte_product_table_payment_total]</td>
            </tr>
        </tbody>
    </table>
...
.clearfix::after {
    ...
    clear: both;
  content: "";}
.wfte_invoice-main{ color:#73879C; font-family:"Helvetica Neue", Roboto, Arial, "Droid Sans", sans-serif; font-size:12px; font-weight:400; line-height:16px; box-sizing:border-box; width:100%; margin:0px; padding:0px;}
...
.wfte_invoice-header_top_right{width:60%;}
...
.wfte_invoice_data{ padding:0px; width:100%;}
...
.wfte_payment_summary_table_body .wfte_right_column{text-align:center; }
...
.wfte_product_table_head th{ height:36px; padding:0px 5px; font-size:.75rem; text-align:center; line-height:10px;  border:solid 1px #212529; font-family:"Helvetica Neue", Roboto, Arial, "Droid Sans", sans-serif;}
...
.wfte_product_table_body td{padding:4px 5px; border:solid 1px #dadada; text-align:center;}
.wfte_payment_summary_table_body td{padding:8px 5px; border:none;}
...
.wfte_return_policy{width:100%; height:auto; border-top:solid 1px #dfd5d5; padding:5px 0px; margin-top:5px; }
.wfte_footer{width:100%; height:auto; border-top:solid 1px #dfd5d5; padding:5px 0px; margin-top:5px;}
.wfte_received_seal{ position:absolute; z-index:10; margin-top:80px; margin-left:200px; width:130px; border-radius:5px; font-size:22px; height:40px; border:solid 5px #00ccc5; color:#00ccc5; font-weight:900; text-align:center; line-height:28px; transform:rotate(-45deg); opacity:.5; 
}
