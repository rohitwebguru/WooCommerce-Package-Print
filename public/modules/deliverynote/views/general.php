...
<p>
	<?php _e('Configure the general settings required for delivery note.','wf-woocommerce-packing-list');?>
</p>
<table class="wf-form-table">
	...
	Wf_Woocommerce_Packing_List_Admin::generate_form_field(array(
		...
		array(
			...
			'help_text'=>sprintf(__('Select/add additional order information in the delivery note.%s Learn how to add order meta %s','wf-woocommerce-packing-list'),'<a href="'.esc_url($order_meta_doc_url).'" target="_blank">', '</a>'),
		),
		array(
			'type'=>"product_meta",
			...
			'module_base'=>$this->module_base,
			'help_text'=>sprintf(__('Selected product meta will be displayed beneath the respective product in the delivery note.<br> %s Learn how to add product meta %s','wf-woocommerce-packing-list'),'<a href="'.esc_url($product_meta_doc_url).'" target="_blank">', '</a>'),
		),
		array(
			...
			'module_base'=>$this->module_base,
			'help_text'=>sprintf(__('Selected product attribute will be displayed beneath the respective product in the delivery note.<br> %s Learn how to add product attribute %s', 'wf-woocommerce-packing-list'),'<a href="'.esc_url($product_attr_doc_url).'" target="_blank">', '</a>'),
		),
		array(
			'type'=>'order_st_multiselect',
			'label'=>__("Enable print delivery note option for order status",'wf-woocommerce-packing-list'),
			'option_name'=>"woocommerce_wf_attach_".$this->module_base,
			'help_text'=>__("Adds print delivery note button to the order email for chosen status",'wf-woocommerce-packing-list'),
