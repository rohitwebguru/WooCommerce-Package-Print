  ...
  <div class="wfte_invoice-header clearfix">
      <div class="wfte_invoice-header_top clearfix">
        <div class="clearfix">
          ...
          <div class="float_right wfte_text_left" style="width:28%;">
...
.wfte_invoice_data_grey{ background-color:#f3f3f3; padding:10px !important; width:25%;}
...
.wfte_product_table_body td{text-align:center; font-size:12px; line-height:10px; border:solid 1px #dadada;}
...
.wfte_return_policy{ width:100%; height:auto; border-top:solid 1px #dfd5d5; padding:5px 0px; margin-top:15px; font-size:10px;}
