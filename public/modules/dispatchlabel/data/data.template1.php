<style type="text/css">
  .clearfix::after {
    ...
    .wfte_addrss_fields{ width:50%; line-height:14px;}
    ...
    .wfte_product_table_body td, .wfte_payment_summary_table_body td{padding:8px 5px;font-size:12px; line-height:10px; border:solid 1px #dadada;}
    .wfte_product_table_body td{ text-align:center; }
