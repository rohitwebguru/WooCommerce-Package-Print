...
<div class="wrap">
	...
	<?php _e('Settings','wf-woocommerce-packing-list');?>: <?php _e('Dispatch Label','wf-woocommerce-packing-list');?>
	</h2>
	...
	<div class="wf-tab-container">
        ...
        <form method="post" class="wf_settings_form">
            <input type="hidden" value="dispatchlabel" class="wf_settings_base" />
            <?php
            // Set nonce:
