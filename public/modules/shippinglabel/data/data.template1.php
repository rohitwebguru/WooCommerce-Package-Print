...
.wfte_header{background:#ffffff; color:#000; padding:10px 20px; width:100%;}
...
.wfte_addrss_fields{ line-height:16px;}
.wfte_shipping_address{ margin-left:20%;}
...
.wfte_shipping_details{ font-weight:bold; }
.wfte_shipping_details div span:first-child{ font-weight:normal; }
.wfte_tracking_number{ text-align:center; font-size:14px; padding-bottom:15px;}
...
.wfte_rtl_template_main .wfte_shipping_address{ margin-left:auto !important; margin-right:20%; }
</style>
<div class="wfte_rtl_main wfte_main wfte_custom_shipping_size">
  ...
  <div class="wfte_body clearfix">
    <div class="wfte_addrss_field_main clearfix">
      ...
      <div class="wfte_shipping_details float_right wfte_list_view">
