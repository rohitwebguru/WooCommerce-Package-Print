...
class Wf_Woocommerce_Packing_List_Pdf_generator
{
    ...
    /**
    *   @since 4.0.0
    *   @since 4.0.9 Added compatiblity to handle multiple PDF libraries
    *   @since 4.1.6 If current active PDF library not found then automatically switch default one.
